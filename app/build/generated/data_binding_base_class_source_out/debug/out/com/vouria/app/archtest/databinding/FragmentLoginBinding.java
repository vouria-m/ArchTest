...
public abstract class FragmentLoginBinding extends ViewDataBinding {
  @NonNull
  public final TextView txtGoToForgetPage;

  @NonNull
  public final TextView txtGoToMain;

  protected FragmentLoginBinding(Object _bindingComponent, View _root, int _localFieldCount,
      TextView txtGoToForgetPage, TextView txtGoToMain) {
    super(_bindingComponent, _root, _localFieldCount);
    this.txtGoToForgetPage = txtGoToForgetPage;
    this.txtGoToMain = txtGoToMain;
  }
